  ...
  return (
    <section className="container space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24">
      <div className="mx-auto flex max-w-[48rem] flex-col">
        ...
        <p className="mb-12">
          These terms and conditions outline the rules and regulations for the use of GrihaBhoomi's
          Website. By using this website, you accept these terms and conditions in full. If you
        ...
        <p className="mb-12">
          Unless otherwise stated, GrihaBhoomi and/or its licensors own the intellectual property
          rights for all material on website. All intellectual property rights are reserved.
        </p>
        <h2 className="text-xl font-bold border-b mb-4">2. Hyperlinking to our Content</h2>
        <p className="mb-12">
          The following organizations may link to our website without prior written approval:
          Government agencies, search engines, news organizations, etc.
        </p>
        <h2 className="text-xl font-bold border-b mb-4">3. Content Liability</h2>
        <p className="mb-12">
          We shall not be hold responsible for any content that appears on GrihaBhoomi. You agree to
          protect and defend us against all claims that may rise on GrihaBhoomi.
        </p>
        ...
        <p className="mb-12">
          ...
          website. You approve to immediately remove all links to our GrihaBhoomi website upon
          request.
        </p>
      </div>
    </section>
