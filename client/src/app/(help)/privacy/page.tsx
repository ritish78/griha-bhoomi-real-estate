...
export default function PrivacyPolicyPage() {
  return (
    <section className="container space-y-6 bg-slate-50 py-8 dark:bg-transparent my-10">
      <div className="mx-auto flex max-w-[48rem] flex-col">
        <h2 className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl mb-6">Privacy Policy</h2>
        <p className="mb-12">
          This privacy policy outlines the rules and regulations for the use of GrihaBhoomi's Website. By
          using this website, you accept this privacy policy in full. If you disagree with this privacy policy
          or any part of this privacy policy, you must not use this website.
        </p>
        ...
        <p className="mb-12">
          ...
          register or make a purchase on our website. We will use this information to provide you with our
          services and support.
        </p>
        <h2 className="text-xl font-bold border-b mb-4">2. Cookies</h2>
        <p className="mb-12">
          Our website uses cookies to enhance your experience. By using our website, you consent to the use of
