...
exports.dummyPropertyData = void 0;
...
exports.dummyPropertyData = [
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Experience urban luxury living in this sleek and contemporary condo located in the heart of downtown LA.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Enjoy breathtaking ocean views and luxurious living in this elegant seaside villa located in Malibu.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Step into elegance and history with this stunning historic townhouse located in the heart of Paris.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Indulge in tropical paradise with this luxurious beachfront villa located in the exotic island of Phuket, Thailand.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Experience contemporary urban living in this stylish loft located in the vibrant neighborhood of Berlin Mitte.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Escape to coastal serenity with this charming retreat located in the picturesque city of Sydney, Australia.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Embrace lakeside living with this cozy cottage nestled along the shores of Lake Ontario in Canada.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Experience the breathtaking beauty of Santorini with this charming hillside villa overlooking the Aegean Sea.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Escape to the majestic Colorado Rockies with this secluded mountain retreat offering panoramic views and tranquility.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Embrace the tranquility of Lake Lucerne with this charming lakeside chalet offering stunning views and alpine charm.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Experience the essence of traditional Japanese architecture with this magnificent riverside mansion located in Kyoto.",
        toRent: false,
        address: "Kyoto, Japan",
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Immerse yourself in the tropical paradise of Bali with this stunning villa surrounded by lush greenery and tranquil waters.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Escape to the serenity of New Zealand's South Island with this cozy lakeside cabin located near Queenstown.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Embrace the Mediterranean lifestyle with this luxurious coastal villa perched along the stunning cliffs of the Amalfi Coast in Italy.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Indulge in lakeside luxury with this magnificent mansion boasting panoramic views of Lake Geneva in Switzerland.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Experience the energy of Tokyo with this modern apartment situated in the bustling heart of the city in Japan.",
        toRent: true,
        address: "Tokyo, Japan",
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Live the wine country dream with this sprawling vineyard estate nestled in the picturesque Napa Valley of California, USA.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Experience luxury beach living with this sleek apartment located directly on the vibrant shores of Miami Beach, Florida, USA.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Escape to the Canadian Rockies with this charming mountain chalet located in the breathtaking town of Banff, Alberta, Canada.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Discover serenity with this elegant seaside villa overlooking the crystal-clear waters of the Aegean Sea on the enchanting island of Santorini, Greece.",
        toRent: false,
        address: "Santorini, Greece",
        closeLandmark: "Oia",
        propertyType: "House",
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Experience the ultimate ski getaway with this cozy chalet nestled in the Swiss Alps in the renowned ski resort town of Verbier, Switzerland.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Relax and unwind in this stylish beach house located in the trendy coastal town of Byron Bay, Australia, boasting stunning ocean views and laid-back vibes.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Immerse yourself in the beauty of the Tuscan countryside with this exquisite estate offering sprawling vineyards, rolling hills, and unparalleled tranquility.",
        toRent: false,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Live the beachfront lifestyle with this modern apartment boasting panoramic views of the Atlantic Ocean in the vibrant city of Rio de Janeiro, Brazil.",
        toRent: true,
    ...
    },
    {
        ...
        slug: "testing-inserting-to-db",
        description: "Step into history with this magnificent colonial mansion located in the UNESCO World Heritage Site of Cartagena, Colombia, boasting timeless architecture and old-world charm.",
        toRent: false,
...
console.log(exports.dummyPropertyData.length);
